...
export default function Home() {
  ...
  const { ws,setMainUser } = useWebSocket();
  ...
  return (
    <div className="relative h-screen w-screen">
      ...
      <div className="h-full flex flex-col items-center bg-black bg-opacity-50">
        ...
        <h1 className="text-purple-400 font-lugrasimo font-semibold text-center text-4xl md:text-5xl xl:text-[5rem] mb-10 lg:mb-16 mt-20">
          Pattern Memory Game
        </h1>
        ...
        {isArenaCreated ? (
          <div className="flex flex-col items-center">
            <div
              className="flex items-center border-2 py-3 px-4 rounded-xl space-x-4 cursor-pointer transition duration-300"
              onClick={handleCopyArenaId}
            >
              <span className="font-bold  text-xl lg:text-2xl text-white italic">{arenaId}</span>
              <ClipboardCopy className="w-5  h-5 hover:scale-110 text-white" />
            </div>
            <p className="text-xl  text-center lg:text-2xl text-purple-300 mt-4 lg:mt-6">
